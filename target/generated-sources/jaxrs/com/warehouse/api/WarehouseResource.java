...
public interface WarehouseResource {
  ...
  @GET
  @Produces("application/json")
  Warehouse getAWarehouseUnitByID(@PathParam("id") @Pattern(regexp = "^[1-9][0-9]*$") String id);

  @Path("/{id}")
  @DELETE
  void archiveAWarehouseUnitByID(@PathParam("id") @Pattern(regexp = "^[1-9][0-9]*$") String id);
  ...
  Warehouse replaceTheCurrentActiveWarehouse(
      @PathParam("businessUnitCode") @Size(max = 40) @Size(min = 1) String businessUnitCode, @NotNull Warehouse data);
}
